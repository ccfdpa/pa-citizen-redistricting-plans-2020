...
The primary purpose of this repository has been to support a [Concerned Citizens for Democracy](https://ccfdpa.org/) whitepaper on citizen involvement in Pennsylvania redistricting. The secondary purpose is to provide researchers and advocates the benefit of our work in gathering these plans from multiple sources and peparing them for analysis.
